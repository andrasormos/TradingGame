...
df = pd.read_csv("/home/andras/PycharmProjects/TradingGame/new_crypto/Gdax_LTCUSD_1h.csv", index_col=0)
...
df.to_csv("/home/andras/PycharmProjects/TradingGame/new_crypto/Gdax_LTCUSD_1h_close_dropped.csv", index=True)
