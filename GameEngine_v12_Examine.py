...
class PlayGame(object):
    def __init__(self):
        ...
        self.trainLogName = "/home/andras/PycharmProjects/TradingGame/logs/trainLog_000.csv"
        self.evalLogName = "/home/andras/PycharmProjects/TradingGame/logs/evalLog_000.csv"
    ...
    def nextStep(self, action):
        ...
        if 1 == 1:
            ...
            if self.actionTaken == 1 and self.guessedRight == 1:
            ...
            elif self.actionTaken == 1 and self.guessedRight == -1:
            ...
            if self.actionTaken == 2 and self.guessedRight == 1:
                ...
                plt.savefig(fileName)
            elif self.actionTaken == 2 and self.guessedRight == -1:
        ...
        self.previousAction = self.actionTaken
