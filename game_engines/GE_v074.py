...
class PlayGame(object):
    def __init__(self):
        ...
        self.training_df_BTC = pd.read_csv("./new_crypto/Gdax_ETHUSD_1h_close_train.csv")
        self.eval_df_BTC = pd.read_csv("./new_crypto/Gdax_ETHUSD_1h_close_eval.csv")
        self.training_df_ETH = pd.read_csv("./new_crypto/Gdax_BTCUSD_1h_close_train.csv")
        self.eval_df_ETH = pd.read_csv("./new_crypto/Gdax_BTCUSD_1h_close_eval.csv")
        self.sma = 168
