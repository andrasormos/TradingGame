...
class PlayGame(object):
    def __init__(self):
        ...
        self.training_df_BTC = pd.read_csv("./cryptoExtract/trainEval/train_BTC_GBP.csv", index_col=0)
        self.eval_df_BTC = pd.read_csv("./cryptoExtract/trainEval/eval_BTC_GBP.csv", index_col=0)
        self.training_df_ETH = pd.read_csv("./cryptoExtract/trainEval/train_ETH_USD.csv", index_col=0)
        self.eval_df_ETH = pd.read_csv("./cryptoExtract/trainEval/eval_ETH_USD.csv", index_col=0)
        self.sma = 168
