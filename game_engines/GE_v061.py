...
class PlayGame(object):
    ...
    def nextStep(self, action):
        ...
        if action == 1:
            ...
            tradingFee = self.fiatToTrade * 0.003
            amountOfBTCBought = (self.fiatToTrade - tradingFee) / self.btcDuringAction
        ...
        if action == 2:
            ...
            self.cashBalance = self.cashBalance + ((leftOverBTC - tradingFee) * self.btcDuringAction)
        ...
        if self.fiatMoneyInvested == 0:
            ...
            self.percentProfitReward = (self.profit / self.fiatMoneyInvested) * 100
        ...
        print("action received", self.actionReceived)
        print("price", self.btcDuringAction)
        #print("Spent:", self.fiatMoneyInvested, "|Worth:", np.round((100 /  self.btcDuringAction), 4), "BTC")
        #print("Spent: 99.7|Worth:", np.round((99.7 / self.btcDuringAction), 4), "BTC")
        print("BTC  Bal:", self.BTC_Balance, " worth= $", (self.BTC_Balance * self.btcDuringAction) )
        print("Fiat Bal:", self.cashBalance)
        this = round((self.cashBalance + (self.BTC_Balance * self.btcDuringAction)), 4)
        print("Sum  Bal:", this)
        print("Ini  Bal:", self.initialBalance)
        print("ONE HOUR LATER")
        print("BTC Price|", self.btcDuringAction, "-->", self.btcForState, "|", self.BTCPercentChange, "%")
    ...
    def getChartImage(self, timeFrame):
        ...
        def profitMeter(chart):
            ...
            radius = reMap(self.fiatMoneyInvested, 0,2000,1,10, 10, 1)
